  ...
  content              = <<EOF
    ...
    all:
      ...
      vars:
        ...
        rhel9cis_bootloader_password: somepasswordthatisnotthesameashashbelow
        rhel9cis_bootloader_salt: somesaltthatisnotthesameasabove
        rhel9cis_authselect_custom_profile_name: mpg_test
        ...
        rhel10cis_sudoers_exclude_nopasswd_list: "{{ sudoers_exclude_nopasswd_list }}"
        rhel10cis_rule_5_6_6: false  # skip root passwd check and keys only
        rhel10cis_rule_5_2_4: false # skip user password
        rhel10cis_rule_5_4_2_4: false # v2 skip root password
        rhel10cis_set_boot_pass: true
        rhel10cis_bootloader_password: somepasswordthatisnotthesameashashbelow
        rhel10cis_bootloader_salt: somesaltthatisnotthesameasabove
        rhel10cis_bootloader_password_hash: grub.pbkdf2.sha512.10000.9306A36764A7BEA3BF492D1784396B27F52A71812E9955A58709F94EE70697F9BD5366F36E07DEC41B52279A056E2862A93E42069D7BBB08F5DFC2679CD43812.6C32ADA5449303AD5E67A4C150558592A05381331DE6B33463469A236871FA8E70738C6F9066091D877EF88A213C86825E093117F30E9E1BF158D0DB75E7581B  # pragma: allowlist secret
        rhel10cis_authselect_custom_profile_name: mpg-cis
        rhel10stig_disruption_high: true
        rhel10stig_set_bootloader_password: true
        ...
        deb13cis_disable_dynamic_motd: true
        ## Ubuntu variables
